 ...
 * @subpackage shandy_blocks/admin
 */
...
class shandy_blocks_Admin {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $shandy_blocks       The name of this plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->shandy_blocks, plugin_dir_url( __FILE__ ) . 'css/shandy_blocks-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->shandy_blocks, plugin_dir_url( __FILE__ ) . 'js/shandy_blocks-admin.js', array( 'jquery' ), $this->version, false );
